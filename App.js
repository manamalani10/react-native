  ...
  render() {
    ...
    return (
      <View>
        ...
        <Video source={{uri:'http://commondatastorage.googleapis.com/gtv-videos-bucket/sample/Sintel.mp4'}} style={{width:500,height:300}} controls={true} selectedTextTrack={{ type: 'title', value: 'English CC' }} textTracks={[
  {
    title: 'English CC',
    language: 'en',
